...
2. Download the zip for the skill you want from the [latest release](https://github.com/JacobHsu/cc-finance-skills/releases/latest) (e.g., `options-payoff.zip`)
...
Based on [himself65/finance-skills](https://github.com/himself65/finance-skills) by himself65.
